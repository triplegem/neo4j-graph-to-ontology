"""
Serialize a SemanticGraph as RDF-star/Turtle-star.

Relationship properties will be serialized as annotations on RDF triples.
"""
...
def build_graph_star(
    semantic_graph: SemanticGraph,
) -> Graph:
    """
    Build an RDFLib Graph from a SemanticGraph.

    Currently this produces standard RDF. RDF-star support will
    extend relationship serialization with triple annotations.
    """
...
def serialize_rdf_star(
    semantic_graph: SemanticGraph,
    filename: str = "graph_star.ttl",
):
    """
    Serialize a SemanticGraph as RDF-star/Turtle-star.

    The current implementation emits standard RDF and serves as
    the foundation for future RDF-star serialization.
    """

    graph = build_graph_star(semantic_graph)
