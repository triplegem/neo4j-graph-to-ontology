...
def render_generated_artifacts():
    ...
    artifacts = [
        ...
        (GRAPH, "Binary RDF graph"),
        (GRAPH_NARY, "N-ary RDF graph with provenance"),
        (GRAPH_INFERRED, "OWL RL inferred RDF graph"),
        (GRAPH_INFERRED_CLEAN, "Cleaned inferred RDF graph"),
