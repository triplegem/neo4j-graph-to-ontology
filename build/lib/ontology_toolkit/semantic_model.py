...
class RelationshipInstance:
    ...
    This object stores the original Neo4j relationship type,
    the ontology relationship class, and the semantic predicate
    used by serializers.
    """
    ...
    # Ontology relationship class (e.g. AuthorOfRelationship)
